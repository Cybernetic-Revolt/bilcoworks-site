...
export const metadata: Metadata = {
  ...
  description:
    'Everything we build runs on servers we own and operate: a virtualized production environment with local LLM inference, automated provisioning, secrets discipline, and tested restores.',
  alternates: {
    canonical: 'https://bilcoworks.com/infrastructure',
  },
  openGraph: {
    title: 'Servers & Infrastructure | Bilco Works',
    description:
      'The self-hosted production environment our products and research run on.',
      ...
      <section className="section-padding">
        <div className="container-narrow">
          <Reveal>
            ...
            <div className="mt-8">
              <Link href="/" className="text-ink font-medium link-underline">
              All practices
            </Link>
            </div>
          </Reveal>
