...
export const metadata: Metadata = {
  title: 'TwoRing & Switchboard | Voice AI | Bilco Labs',
  description:
  ...
  alternates: {
    canonical: 'https://bilcoworks.com/labs/tworing',
  },
  openGraph: {
    title: 'TwoRing & Switchboard | Bilco Labs',
    description:
      'A 24/7 AI receptionist for trade businesses, and the self-hosted voice engine underneath it.',
    url: 'https://bilcoworks.com/labs/tworing',
      ...
      <section className="relative section-padding bg-surface-secondary border-b border-rule overflow-hidden">
        ...
        <div className="container-wide">
          <Reveal className="max-w-2xl">
            <p className="eyebrow">Labs / Product</p>
