...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://bilcoworks.com/research',
  },
  openGraph: {
      ...
      <section className="section-padding">
        <div className="container-wide">
          ...
          <Reveal className="mt-12 flex flex-wrap gap-x-8 gap-y-3">
            <Link href="/ai/knee-ledger" className="text-ink font-medium link-underline">
              The same discipline, under competition pressure: The Knee Ledger
            </Link>
